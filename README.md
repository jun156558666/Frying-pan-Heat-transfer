...
- **アルミ・鉄・SUS・PF**：最高温度は ±10% 以内に収まっている。
- **銅**：最高温度が +21.7% 高め。銅は熱伝導率が高くほぼ等温になるため、SolidWorksのボウル形状（深さ約 50 mm）の大きな側面冷却を薄いリム（H = 3 mm）に集約している本モデルとの差が出やすい。
